...
//
//		//if (!ResourceManager::GetResource(L"2d_widget_default", v_positions))
//		//{
...
//		//	};
//		//	COM_ERROR_IF_FAILED(v_positions->Initialize(device, vertices), L"Failed to initialize vertex buffer for 2d widget.");
//		//	
//		//	ResourceManager::RegisterResource(L"2d_widget_default", v_positions);
//		//}
//
